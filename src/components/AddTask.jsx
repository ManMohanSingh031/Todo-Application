    ...
    <div className="flex flex-col justify-between items-center bg-gray-200 p-4">
      <div className="flex justify-between w-1/2 h-16 rounded-lg bg-white items-center p-2">
        <button
          onClick={toggleForm}
          type="button"
          className="flex justify-center items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
        >
